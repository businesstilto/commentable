        ...
        <div class="flex-1 space-y-2">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-1">
                    <x-filament::icon-button icon="heroicon-o-pencil-square" size="xs" tooltip="Bewerken"
                        color="gray"
                        class="!p-0 !m-0 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200" />

                    @can('delete', $comment)
                        <x-filament::modal icon="heroicon-s-trash" icon-color="danger" alignment="center" width="md">
                            <x-slot name="trigger">
                                <x-filament::icon-button icon="heroicon-o-trash" size="xs" tooltip="Verwijderen"
                                    color="gray"
                                    class="!p-0 !m-0 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200" />
                            </x-slot>
